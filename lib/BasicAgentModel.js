...
var bicycleWeightage = 0.6 //static
var motorcycleWeightage = 0.6 //static
var carWeightage = 0.6 //static
...
var probOrderArrival = 0.8  //dynamic
var probDriverArrival = 0.2  //dyhamic
...
function updateSurface(){
	...
	allstatistics.selectAll("text").text(function(d) {
		return d.type+" drivers' average delivery time: "+d.average.toFixed(1); }); //The toFixed() function sets the number of decimal places to display
	...
	allpricestatistics.selectAll("text").text(function(d) {
		return d.type+" : "+d.value.toFixed(3); }); //The toFixed() function sets the number of decimal places to display
...
function adjustPricing(timeobject){
	var coefficientRatio = bicycleWeightage*(timeobject[0].average / bicycleOptimalServiceTime) + motorcycleWeightage*(timeobject[1].average / motorcycleOptimalServiceTime) + carWeightage*(timeobject[2].average / carOptimalServiceTime)
