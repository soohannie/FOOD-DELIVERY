...
function simDataCollector(){
	if (currentTime <= numRuns && dataCollectionSwitch == true){
		simDataObject = {
			...
			bicycleDelivery:timeobject[0].average,
			motorcycleDelivery:timeobject[1].average,
			carDelivery:timeobject[2].average,
			revenue:analyticsdataobject[4].value,
			idleDrivers:analyticsdataobject[3].value,
			ordersServing:analyticsdataobject[5].value
		}
		...
		simDataObject = {
			time: currentTime,
			run:repetitionCounter,
			bicycleDeliveryDP:timeobject[0].average,
			motorcycleDeliveryDP:timeobject[1].average,
			carDeliveryDP:timeobject[2].average,
			revenueDP:analyticsdataobject[4].value,
			idleDriversDP:analyticsdataobject[3].value,
			ordersServingDP:analyticsdataobject[5].value
		}
